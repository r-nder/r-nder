//! Items related to wgpu and its integration in umble!
//!
//! **WebGPU** is the portable graphics specification that umble targets allowing us to write code
...
//! adding some additional items that makes `wgpu` easier to use alongside umble.
//!
...
//!
//! Note that when using `umble_wgpu` via `umble::wgpu`, both features are enabled by default.
//!
//! Useful links:
//!
//! - An awesome [guide for wgpu-rs](https://sotrh.github.io/learn-wgpu/#what-is-wgpu). Highly
//!   recommended reading if you would like to work more closely with the GPU in umble!
...
pub use self::texture::resharper::Reshaper as TextureReshaper;
...
/// umble's default WGPU backend preferences.
...
pub fn shader_from_spirv_bytes(
    ...
    let desc = ShaderModuleDescriptor {
        label: Some("umble_shader_module"),
        source,
    };
