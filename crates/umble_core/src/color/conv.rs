...
// ///
// /// This trait is important for umble as the `Draw` API works with the `LinSrgba` type as a target
...
// TODO - This wrapper is wrong now since palette 0.7.0. Component trait did not exist anymore (Component trait seem to be replaced by Stimulus trait).
// TODO - Need to rework that when we use it. This is not possible currently without any concrete tests.