...
use crate::math::range::{Align, Edge, Range};
...
impl Rect<f32> {
    ...
    pub fn xy_wh(&self) -> (Point2, Vector2) {
        (self.xy(), self.wh())
    }
    ...
    pub fn shift(self, v: Vector2) -> Self {
