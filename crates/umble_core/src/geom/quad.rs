...
use crate::geom::{tri, vertex, Vertex, Vertex2d, Vertex3d};
use crate::geom::cuboid::Cuboid;
        ...
        V: Vertex,
{
    ...
    ///
    /// ```
    /// # use umble_core as umble;
    ///
    /// fn main() {
    ///     use umble_core::geom::quad::Quad;
    ///     use umble_core::geom::tri::Tri;
    ///     use umble_core::{geom, math};
    ///     use umble_core::math::point::point_2;
    ///     let a = point_2(0.0, 1.0);
    ///     let b = point_2(1.0, 1.0);
    ///     let c = point_2(1.0, 0.0);
    ///     let d = point_2(0.0, 0.0);
